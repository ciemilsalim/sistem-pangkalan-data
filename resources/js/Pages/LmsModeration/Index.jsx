                    ...
                    {activeTab === 'ai' && (
                        <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <div className="rounded-xl bg-white dark:bg-gray-800 p-5 border border-gray-200 dark:border-gray-700 flex items-center gap-4 shadow-sm">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="text-xl font-bold text-gray-800 dark:text-gray-200 font-mono mt-0.5">{ai_caches.length} Respon Terlindungi</h4>
                                    </div>
                                </div>
                                <div className="rounded-xl bg-white dark:bg-gray-800 p-5 border border-gray-200 dark:border-gray-700 flex items-center gap-4 shadow-sm">
                                        ...
                                        <tbody className="divide-y divide-gray-100 text-sm text-gray-700 dark:text-gray-300">
                                            {ai_caches.map((cache) => (
                                                <tr key={cache.id} className="hover:bg-slate-50/50 transition-colors">
                                                    <td className="px-6 py-4 font-mono font-bold text-xs text-indigo-600 truncate max-w-[100px]">{cache.hash}</td>
                                                    <td className="px-6 py-4">
                                ...
                                <div className="p-6 space-y-4 bg-slate-50/50">
                                    {ai_prompts.length > 0 ? (
                                        ai_prompts.map((prompt) => (
                                            <div key={prompt.id} className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm">
                                                <div className="flex items-baseline justify-between gap-2 border-b border-gray-100 pb-2.5">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <span className="rounded bg-indigo-50 px-1.5 py-0.25 text-[9px] font-extrabold text-indigo-600 font-mono uppercase">
                                                            {prompt.key}
                                                        </span>
                                                    </div>
                                                    <span className="text-[10px] text-gray-400 font-semibold">
                                                        Penyusun: <span className="text-gray-600 dark:text-gray-400 font-bold">{prompt.teacher?.name || 'Sistem Default (Global)'}</span>
                                                    </span>
                                                </div>
                                        ...
                                        <div className="space-y-4">
                                            <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 shadow-sm">
                                                <div className="flex items-baseline justify-between gap-2 border-b border-gray-100 pb-2.5">
                                                    ...
                                                    <span className="text-[10px] text-gray-400 font-semibold">
                                                        Penyusun: <span className="text-gray-600 dark:text-gray-400 font-bold">Sistem Default (Global)</span>
                                                    </span>
                                                </div>
                                                <p className="text-xs text-gray-550 leading-relaxed mt-3">
