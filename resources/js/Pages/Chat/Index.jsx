        ...
        >
            ...
            <div className="py-6">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="flex h-[calc(100vh-200px)] min-h-[500px] overflow-hidden rounded-xl bg-white shadow-md">
                        
                        {/* LEFT SIDEBAR - CONTACT LIST */}
                        <div className="flex w-full flex-col border-r border-gray-200 md:w-80 lg:w-96 shrink-0 bg-gray-50/50">
                            {/* Search bar */}
                            <div className="p-4 border-b border-gray-200 bg-white">
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full rounded-lg border-gray-300 pl-10 pr-4 text-sm focus:border-blue-500 focus:ring-blue-500"
                                        value={search}
                                    ...
                                    filteredConversations.map((conv) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`w-full flex items-start gap-3 p-4 text-left transition-colors duration-150 hover:bg-gray-100 ${
                                                    isSelected ? 'bg-blue-50 hover:bg-blue-50 border-l-4 border-blue-500' : ''
                                                }`}
                                            >
                                                {/* Avatar */}
                                                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 font-bold text-white shadow-sm">
                                                    {initial}
                                                </div>
                        ...
                        <div className="flex flex-1 flex-col bg-slate-50">
                            {activeConversation ? (
                                <>
                                    ...
                                    <div className="flex items-center justify-between border-b border-gray-200 bg-white px-6 py-4 shadow-sm z-10">
                                        <div className="flex items-center gap-3">
                                            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 font-bold text-white">
                                                    ...
                                                    <div key={msg.id} className="space-y-4">
                                                        {showDateDivider && (
                                                            <div className="flex justify-center my-4">
                                                                <span className="rounded-full bg-gray-200 px-3 py-1 text-[10px] font-semibold text-gray-600 uppercase tracking-wider">
                                                        ...
                                                        <div className={`flex ${isAdminSender ? 'justify-end' : 'justify-start'}`}>
                                                            ...
                                                            >
                                                                ...
                                                                <div className={`mt-1 flex items-center justify-end gap-1 text-[9px] ${
                                                                    isAdminSender ? 'text-blue-100' : 'text-gray-400'
                                                                }`}>
                                                                    ...
                                                                    {isAdminSender && (
                                                                        <span>
                                                                            {msg.read_at ? (
                                                                                ...
                                                                                <svg className="h-3.5 w-3.5 fill-current text-emerald-300" viewBox="0 0 24 24">
                                                                                ...
                                                                                <svg className="h-3.5 w-3.5 fill-current text-blue-200" viewBox="0 0 24 24">
                                    ...
                                    {/* Input Message Area */}
                                    <form onSubmit={handleSubmit} className="border-t border-gray-200 bg-white p-4 flex items-end gap-3 shadow-[0_-2px_10px_rgba(0,0,0,0.02)]">
                                        <textarea
                                            placeholder="Tulis pesan..."
                                            rows="1"
                                            className="flex-1 resize-none rounded-xl border-gray-300 py-2.5 px-4 text-sm focus:border-blue-500 focus:ring-blue-500 max-h-24 min-h-[40px] focus:outline-none"
                                            value={data.body}
                                        ...
                                        <button
                                            ...
                                            className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-600 text-white transition-colors duration-150 hover:bg-blue-700 disabled:bg-gray-200 disabled:text-gray-400 shrink-0"
                                        >
                                            {processing ? (
                                ...
                                <div className="flex h-full flex-col items-center justify-center p-8 text-center bg-slate-50">
                                    <div className="flex h-16 w-16 items-center justify-center rounded-full bg-blue-100 text-blue-600 mb-4 shadow-sm">
