                ...
                <div className="mt-4 flex items-center justify-end">
                    {canResetPassword && (
                        <Link
                            ...
                            className="rounded-md text-sm text-gray-600 dark:text-gray-400 underline hover:text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                        >
